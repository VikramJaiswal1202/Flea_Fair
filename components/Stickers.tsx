    ...
    <section className="w-full flex justify-center md:justify-start items-center px-4 sm:px-6 md:px-8 lg:px-12 mt-10 md:mt-0">
      ...
      <div className="relative w-full max-w-[280px] xs:max-w-[320px] sm:max-w-[380px] md:max-w-[480px] lg:max-w-[560px] xl:max-w-[640px] aspect-[1.1/1]">
        ...
        <motion.img
          ...
          alt="Small Business"
          className="absolute bottom-[28%] left-[10%] w-[78%] sm:w-[76%] md:w-[78%] -rotate-2 z-20"
          {...scaleIn}
        />
        ...
        <motion.img
          src=""
          alt="Food"
          className="absolute top-[4%] left-[6%] w-[62%] sm:w-[60%] md:w-[62%] -rotate-6 z-30"
          {...scaleIn}
          transition={{ delay: 0.1, duration: 0.8, ease: cubicBezier(0.65, 0, 0.35, 1) }}
        />
        ...
        <motion.img
          ...
          {...scaleIn}
          transition={{ delay: 0.2, duration: 0.8, ease: cubicBezier(0.65, 0, 0.35, 1) }}
        />

        <motion.img
          src="/music.png"
          alt="Music"
          className="absolute top-[26%] left-[28%] w-[63%] sm:w-[61%] md:w-[63%] -rotate-2 z-20"
          {...scaleIn}
          transition={{ delay: 0.15, duration: 0.8, ease: cubicBezier(0.65, 0, 0.35, 1) }}
        />
        ...
        <motion.img
          ...
          {...scaleIn}
          transition={{ delay: 0.25, duration: 0.8, ease: cubicBezier(0.65, 0, 0.35, 1) }}
        />
        ...
        <motion.img
          ...
          {...scaleIn}
          transition={{ delay: 0.3, duration: 0.8, ease: cubicBezier(0.65, 0, 0.35, 1) }}
        />
      </div>
    </section>
  );
